...
var List = function List(props) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            "div",
            { className: "col-md-2 col-sm-2 col-xs-3 delete-icon pt-0 pb-0 invisible" },
            _react2.default.createElement(
                "div",
                { className: "col pb-0" },
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'row' },
        _react2.default.createElement(_NavBar2.default, { isLogged: isLogged }),
        ' ',
        View
      );
    }
...
var _reactSwipeToRevealOptions = __webpack_require__(50);

var _reactSwipeToRevealOptions2 = _interopRequireDefault(_reactSwipeToRevealOptions);
    ...
    _createClass(ListView, [{
        ...
        value: function render() {
            ...
            var ListItems = dataSet.map(function (item) {
                return _react2.default.createElement(
                    _reactSwipeToRevealOptions2.default,
                    {
...
var LoginForm = function (_Component) {
    ...
    _createClass(LoginForm, [{
        ...
        value: function verifyPassword() {
            var strongRegex = new RegExp("^(?=.*[A-Z])(?=.*[!@#\$%\^&\*])(?=.{8,})");
            var bool = strongRegex.test(this.state.passWord);
            this.setState({
                disableBtn: !bool
            });
        }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'form',
                    { onSubmit: this.props.userLogged },
                    _react2.default.createElement(
                        'div',
                    ...
                    _react2.default.createElement(
                        'button',
                        { type: 'submit', className: 'btn btn-primary', disabled: disableBtn },
                        'Login'
                    )
                )
            );
