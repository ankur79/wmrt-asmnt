        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement("i", { className: "fa fa-diamond fa-2", "aria-hidden": "true" }),
                    "\xA0",
                    item.name
                ),
                _react2.default.createElement(
...
var _LoginForm = __webpack_require__(51);

var _LoginForm2 = _interopRequireDefault(_LoginForm);

var _DataSet = __webpack_require__(52);
...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    key: 'delteItem',
    value: function delteItem(id) {
      var dataSet = this.state.dataSet;

      var updateData = dataSet.filter(function (item) {
        return item.id !== id;
      });
    ...
    value: function render() {
      ...
      var View = isLogged ? _react2.default.createElement(_ListView2.default, { dataSet: dataSet, delteItem: function delteItem(id) {
          return _this2.delteItem(id);
        } }) : _react2.default.createElement(_LoginForm2.default, { userLogged: function userLogged() {
          return _this2.userLogged();
        } });
      return _react2.default.createElement(
        'div',
        { className: 'row' },
        _react2.default.createElement(_NavBar2.default, { isLogged: isLogged, userLogged: function userLogged() {
            return _this2.userLogged();
          } }),
        ' ',
        View
...
var NavBar = function NavBar(props) {
    ...
    var headerText = isLogged ? _react2.default.createElement(
        "div",
        { className: "sticky-top navbar-dark bg-primary app-header row" },
        _react2.default.createElement(
            "div",
            { className: "col-md-1 col-sm-1 col-xs-1", onClick: function onClick() {
                    return userLogged();
                } },
            _react2.default.createElement(
                "h4",
        ...
        "div",
        { className: "sticky-top navbar-dark bg-primary app-header" },
        _react2.default.createElement(
            "h4",
            { className: "text-white" },
            "Welcome"
...
var _hammer = __webpack_require__(50);
...
var ListView = function (_Component) {
    ...
    _createClass(ListView, [{
        ...
        value: function componentDidMount() {
            var containerEl = document.getElementById("listContainer");
            ...
            var _loop = function _loop() {
                var myElement = document.getElementById(sliderDivs[i].id);
                var deleteEl = document.getElementById(deleteDivs[i].id);
                var sliderWid = myElement.offsetWidth - deleteEl.offsetWidth;
        ...
        value: function render() {
            var _props = this.props,
                ...
                _delteItem = _props.delteItem;

            var ListItems = dataSet.map(function (item) {
                return _react2.default.createElement(_List2.default, { key: item.id, delteItem: function delteItem(id) {
                        return _delteItem(id);
                    }, item: item });
            });
            return _react2.default.createElement(
                'div',
                { className: 'container-fluid', id: 'listContainer' },
                ListItems
            );
        }
    }]);
...
var LoginForm = function (_Component) {
    ...
    _createClass(LoginForm, [{
        ...
        value: function verifyPassword() {
            var strongRegex = new RegExp("^(?=.*[A-Z])(?=.*[!@#\$%\^&\*])(?=.{7,})");
            var bool = strongRegex.test(this.state.passWord) && this.state.userName !== "";
            this.setState({
                disableBtn: !bool
            });
        }
